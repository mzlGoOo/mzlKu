! function(e, t) {
	...
	return function(e) {
		...
		n = function(e) {
			...
			var r = o(1);
			t.prototype.dimensions = ["lng", "lat"], t.prototype.setZoom = function(e) {
				this._zoom = e
			...
			return t.dimensions = t.prototype.dimensions, t.create = function(e, o) {
				...
				e.eachComponent("bmap", function(e) {
					...
					if (i = i || n(), r) throw new Error("Only one bmap component can exist");
					if (!e.__bmap) {
						var s = a.querySelector(".ec-extension-bmap");
						s && (p.style.left = "0px", p.style.top = "0px", a.removeChild(s)), s = document.createElement("div"), s.style.cssText = "width:100%;height:100%", s.classList.add("ec-extension-bmap"), a.appendChild(s);
					...
					r = new t(c, o), r.setMapOffset(e.__mapOffset || [0, 0]), r.setZoom(d), r.setCenter(l), e.coordinateSystem = r
			...
			return o(1).extendComponentView({
				...
				render: function(e, t, o) {
					...
					var r = !0,
						...
						s = function(t, n) {
							if (!r) {
								...
								a.style.left = s[0] + "px", a.style.top = s[1] + "px", p.setMapOffset(s), e.__mapOffset = s, o.dispatchAction({
									type: "bmapRoam"
								})
							}
						};
					...
					var m = e.__mapStyle,
						l = e.get("mapStyle") || {},
						d = JSON.stringify(l);
					JSON.stringify(m) !== d && (Object.keys(l).length && i.setMapStyle(l), e.__mapStyle = JSON.parse(d)), r = !1
				}
			})
		}.call(t, o, t, e), !(void 0 !== n && (e.exports = n))
	}])
